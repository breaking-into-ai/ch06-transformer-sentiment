...
- `attention_from_scratch.py` — self-attention, multi-head attention, and a full transformer block in plain PyTorch, plus the CineMatchNet feed-forward network
